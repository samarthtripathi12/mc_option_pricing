...
if data.empty:
    raise ValueError("No data returned for ticker. Check ticker symbol or internet connection.")
...
# Save GIF
gif_filename = 'Phase5_MC_Animation_Final.gif'
anim.save(gif_filename, writer=PillowWriter(fps=30))
plt.close()
